...
public class XueQiuTest {
    ...
    public void getAllCode() throws Exception {
        ...
        WebAgent<AgentResult> engine = new HtmlEngine().url(apiurl).referer(referer);
    ...
    public void getBonus() throws Exception {
        ...
        Map<String, String> cookies = new HtmlEngine().url(page).execute(new MapUtil<String,Object>().put("code","SH600519").getMap()).getCookies();
        String data = new HtmlEngine().url(apiUrl).referer(referer).cookie(cookies).execute(null).getBody();
    ...
    public void companyInfo() throws Exception {
        ...
        String data = new HtmlEngine()
                .url(apiUrl)
                .referer(page)
                .cookie(new HtmlEngine().url(page).execute(null).getCookies())
    ...
    public void top10() throws Exception {
        ...
        Map<String,String> cookies = new HtmlEngine().url(page).execute(null).getCookies();
        //获取最新的十大股东 及 所有时间列表
    ...
    public void gdrs() throws Exception {
        ...
        Map<String,Object> map = new MapUtil<String,Object>().put("code","SH600887").getMap();
        Map<String,String> cookies = new HtmlEngine().url(page).execute(map).getCookies();
        //获取最新的十大股东 及 所有时间列表
